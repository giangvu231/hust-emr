                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h5
                                                ...
                                                id="exampleModalLongTitle"
                                            >
                                                Sửa lịch sử phẫu thuật của bệnh
                                                nhân
                                            </h5>
                                            <button
                                                type="button"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            >
                                                ...
                                                <center>
                                                    ...
                                                    <button
                                                        type="submit"
                                                        class="updatesurgery btn-block btn btn-info"
                                                        style="color:#fff;"
                                                    >
                                                        Cập nhật lịch sử phẫu
                                                        thuật
                                                    </button>
                                                </center>
                                            </form>
            ...
            this.form
                ...
                .then(() => {
                    ...
                    toast.fire({
                        type: "success",
                        title:
                            "Lịch sử phẫu thuật của bệnh nhân được cập nhật thành công!"
                    });
