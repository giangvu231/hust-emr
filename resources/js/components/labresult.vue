                    ...
                    >
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td>
                                    {{ labresult.patient.full_name }}
                                </td>
                                <!-- <td>{{ labresult.diagnose.diagnosis }}</td> -->
                                <td>{{ labresult.updated_at }}</td>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            >
                                                ...
                                                <center>
                                                    ...
                                                    <button
                                                        type="submit"
                                                        class="updatelabresults btn-block btn btn-info"
                                                        style="color:#fff;"
                                                    >
...
export default {
    ...
    methods: {
        LoadLabresult() {
            axios.get("api/uploadtest").then(response => {
                setTimeout(function() {
                    NProgress.done();
                }, 1000);
