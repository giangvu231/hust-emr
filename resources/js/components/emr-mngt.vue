        ...
        <div class="row justify-content-center">
            ...
            <div class="row card-header">
              ...
              <div class="col-sm-6">
                   <div class="input-group input-group-sm">
                    ...
                    <div class="input-group input-group-sm">
                    <input type="search" v-model="search" @keyup.enter="searchit" class="form-control" placeholder="Nhập mã bệnh nhân">
                    <span class="input-group-append">
                    <button @click="searchit" class="btn btn-info btn-flat" >Tìm kiếm</button>
                    </span>
                    </div>
            ...
            <div class="card-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th>Mã bệnh nhân</th> <!-- col 1 -->
                  <th>Họ tên</th> <!-- col 2 -->
                  <th>Mã HSBA</th> <!-- col 3 -->
                  <th>Ngày khám</th> <!-- col 4 -->
                  <th>Lý do vào viện</th> <!-- col 5 -->
                  <th>Giới tính</th> <!-- col 6 -->
                  <th>Tác vụ</th> <!-- col 7 -->
                </tr>
                </thead>
                <tbody>
                <tr v-for="patient in patients" :key="patient.id">
                  <td>{{patient.id}}</td> <!-- col 1 -->
                  <td>{{patient.full_name}}</td> <!-- col 2 -->
                  <td>{{patient.unique_id}}</td> <!-- col 3 -->
                  <td>{{patient.created_at}}</td> <!-- col 4 -->
                  <td>{{patient.reason}}</td> <!-- col 4 -->
                  <td>{{patient.sex}}</td>
                  <td>
                 ...
                 <!--Biodata Modal -->
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                          ...
                          <div class="modal-body">
                             ...
                             <p><b>Phiếu theo dõi sinh hiệu: </b> <button type="submit">Click here</button> -> open PDF</p>
