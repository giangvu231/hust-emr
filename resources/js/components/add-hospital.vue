<template>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Thêm tiền sử khám của bệnh nhân</div>
                    <div class="card-body">
                        ...
                        <input v-model="form.date_attented" type="date" name="date_attented" placeholder="Nhập ngày vào viện"
                        ...
                        <input v-model="form.date_admitted" type="date" name="date_admitted" placeholder="Điền ngày nhập viện"
                        ...
                        <div class="form-group">                        
                        <input v-model="form.physician" type="text" name="physician" placeholder="Nhập tên Điều dưỡng"
                            class="form-control" :class="{ 'is-invalid': form.errors.has('physician') }">
                        <has-error :form="form" field="physician"></has-error>
                        </div>
                        <div class="form-group">                        
                        <input v-model="form.ward" type="text" name="ward" placeholder="Nhập tên người giám hộ"
                        ...
                        <div class="form-group"> 
                        <textarea v-model="form.symptoms"  placeholder="Nhập các triệu chứng" name="symptoms" id="" cols="10" rows="5"  class="form-control" :class="{ 'is-invalid': form.errors.has('symptoms') }"></textarea>                       
                        <has-error :form="form" field="symptoms"></has-error>                       
                        </div> 
                        <div class="form-group"> 
                        <textarea v-model="form.comment_box"  placeholder="Nhập nhận xét của bác sĩ" name="comment_box" id="" cols="10" rows="5"  class="form-control" :class="{ 'is-invalid': form.errors.has('comment_box') }"></textarea>                       
                        <has-error :form="form" field="comment_box"></has-error>                       
                        </div>                                                         
                        <center>
                        <button type="submit" class="hospital btn-block btn btn-info" style="color:#fff;">
