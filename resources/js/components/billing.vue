    ...
    <div class="container">
        ...
        >
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div style="display: none;" class="paybutton">
                            Hóa đơn của bạn đang được xử lý, bấm chọn nút thanh
                            toán bên dưới để tiếp tục<br />
                            <button
                                type="button"
                                class="btn btn-success pay-pay"
            ...
            <option value="Medication">Medication Fee</option> -->
                                    <option value="Phí tư vấn"
                                        >Phí tư vấn</option
                                    >
                                    <option value="Phí theo dõi"
                                        >Phí theo dõi</option
                                    >
                                    <option value="Phí dịch vụ"
                                        >Phí dịch vụ</option
                                    >
                            ...
                            <center>
                                <button
                                    type="submit"
                                    class="pay btn-block btn btn-info"
                                    style="color:#fff;"
                                >
                                    Gửi đi
                                </button>
    ...
    methods: {
        ...
        payWithPaystack() {
            ...
            var handler = PaystackPop.setup({
                ...
                email: emaill,
                amount: amountt + "00",
                ref: "TT" + Math.floor(Math.random() * 100000000000000 + 1), // generates a pseudo-unique reference. Please replace with a reference you generated. Or remove the line entirely so our API will generate one for you

                callback: function(response) {
                    $(".paybutton").hide();
                    $(".almost_done").html(
                        ' <p><i class="fa fa-spin fa-spinner"></i> <br><b>Đang lưu thông tin</b>.... <br> Vui lòng đợi </p>'
                    );
