                  ...
                  <th v-if="user.role == 'pham'">Action</th> -->
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td>
                                    {{ medication.patient.title }}
                                    {{ medication.patient.full_name }}
                                </td>
                      ...
                      Give Injection
                                    ...
                                    <button
                                        ...
                                        @click="giveinjection(medication)"
                                    >
                                        Chỉ định tiêm
                                    </button>
                                </td>
                                ...
                                >
                                  ...
                                  name="injection" /> Confirm Action First -->
                                                ...
                                                <center>
                                                    ...
                                                    <button
                                                        type="submit"
                                                        class="injectiongive btn-block btn btn-info"
                                                        style="color:#fff;"
                                                    >
                                                        Chỉ định tiêm
                                                    </button>
                               ...
                               <option value="Tablet">Tablet</option>
                                ...
                                name="nurse" /> Refer Patient for injection -->
                                                ...
                                                <center>
                                                    ...
                                                    <button
                                                        type="submit"
                                                        class="updatemedications btn-block btn btn-info"
                                                        style="color:#fff;"
                                                    >
...
export default {
    ...
    methods: {
        ...
        LoadLabresult() {
            axios.get("api/give-injection").then(response => {
                setTimeout(function() {
                    NProgress.done();
                }, 1000);
        ...
        GiveInjectionNow() {
            ...
            this.form
                .put("api/uploadpham/" + this.form.id)
                .then(() => {
